public class metodos {
    ...
    //Método para visualizar el contenido del concesionario.
    public static void mostrarConcesionario(coche[] concesionario){
        if(concesionario[0]==null) {
            System.err.println("La lista de coches está vacía, seleccione la opción 1 para cargar la lista.");
        }else{
